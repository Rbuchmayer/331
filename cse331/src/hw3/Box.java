 ...
 * a BallContainer and a Box is that a Box has a finite volume. Once a box is
 * full, a client cannot put in more Balls.
 */
public class Box implements Iterable<Ball> {
	...
	/**
	 * This method is used to add Ball objects to this box of finite volume. The
	...
	public Iterator<Ball> getBallsFromSmallest() {
		...
		class VolumeComparator implements Comparator<Ball> {
			@Override
		...
		bs.sort(new VolumeComparator());
		return bs.iterator();
	}

	/**
	 * Removes a ball from the box. This method returns <tt>true</tt> if ball
	 * was successfully removed from the container, i.e. ball is actually in the
	 * box. You cannot remove a Ball if it is not already in the box and so ths
	 * method will return <tt>false</tt>, otherwise.
	 * 
	 * @param b
	 *            Ball to be removed.
	 * @requires b != null.
	 * @return true if ball was successfully removed from the box, i.e. ball is
	 *         actually in the box. Returns false, if ball is not in the box.
	 */
	...
	/**
	 * This method returns <tt>true</tt> if this box contains the specified
	 * Ball. It will return <tt>false</tt> otherwise.
	 * 
	 * @param b
	 *            Ball to be checked if its in box
	 * @requires b != null.
	 * @return true if this box contains the specified Ball. Returns false,
	 *         otherwise.
	 */
